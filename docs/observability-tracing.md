...
The trace models the release path across Airflow, Metaflow, MLflow, KServe, and Prometheus. Each span includes `trace_id`, `span_id`, `parent_span_id`, `service`, duration, status, and attributes.
