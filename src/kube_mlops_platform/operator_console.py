...
IDENTITY = ConsoleIdentity(
    product="Kubernetes MLOps Control Plane",
    short_name="KubeOps",
    code="KM",
    environment="minikube / portfolio-lab",
    primary="#087f5b",
    primary_dark="#075f46",
    secondary="#2563a8",
    warning="#c47a16",
...
_NAVIGATION = (
    ("dashboard", "Control plane", IDENTITY.dashboard),
    ("review", "Review cockpit", "judge_demo_cockpit.html"),
    ("drill", "Failure drill", "operator_drill_lab.html"),
    ("signals", "Signal topology", "reliability_signal_mesh.html"),
    ("studio", "Demo runbook", "narrated_demo_studio.html"),
    ("evidence", "Evidence registry", "index.html"),
)
