...
def build_accelerator_capacity_plan(root: str | Path, *, project: str, primary_workload: str) -> dict:
    ...
    plan = {
        ...
        "profiles": [
            {
                "name": "cpu-burst",
                "use_case": "default demo, light training, validation, and report generation",
            ...
            {
                "name": "gpu-shared-l4",
                "use_case": "low-latency inference smoke tests and small batch scoring",
                "node_selector": {"accelerator": "nvidia-l4"},
                "kueue_flavor": "gpu-l4-shared",
                "quota": {"nvidia.com/gpu": "4", "memory": "256Gi"},
                "sharing_mode": "NVIDIA GPU Operator time-slicing for non-isolated dev and canary workloads",
            },
            {
                "name": "gpu-mig-a100",
                "use_case": "isolated training or heavier inference where memory and fault isolation matter",
        ...
        "guardrails": [
            "Use CPU nodes for local demo and most validation jobs.",
            "Reserve shared L4 GPUs for canaries, profiling, and low-risk batch scoring.",
